...
| Parameter name | Presence | Data Type | [Unit](Constants)/format          | Description                                       | Example              |
| -------------- | -------- | --------- | ------------------------------------ | ------------------------------------------------- | -------------------- |
...
| mass aircraft  | Optional | Number    | `kg` in RU files, `lbs` in US files. | The mass of the fighter jet                       | 41780                |
| mass fuel      | Optional | Number    | `kg` in RU files, `lbs` in US files. | The mass of fuel at take off in the fighter jet   | 41780                |
...
RU and US fighter jets do not use the same [Units](Constants) when logging their data.
