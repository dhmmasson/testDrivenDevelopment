...
## 2021
- 24/03/2021 - 10:16 : New algorithm for **phase detection** in [instructions](Pandora-Instructions.md#algorithm).
...
- 20/03/2020 - 00:02 : Added required values for the metadata section in [instructions](Pandora-Instructions.md#metadata)
- 19/03/2020 - 15:27 : Added conversion values for Temperature and Pressure in [instructions](Pandora-Instructions.md#constant-values)
- 19/03/2020 - 15:27 : Added conversion values for power (1 hp = `754.7` W) in [instructions](Pandora-Instructions.md#constant-values)
...
- 18/03/2020 - 23:56 : We added more information in case of [special situations](Pandora-Instructions.md#special-situations)
...
- 18/03/2020 - 15:42 : Flights should be around 4:00 am with your local time zone [timestamp](Pandora-Instructions.md#clues)
- 17/03/2020 - 17:25 : We added some more information about [using timestamp](Pandora-Instructions.md#timestamps) in your program
- 17/03/2020 - 15:26 : We added a simple heuristic to find flight phases [in the instructions](Pandora-Instructions.md#flight-phases) along with a pseudo-code in python
...
- 13/03/2020 - 15:00 : you can find more about tests files [here](Pandora-Flight_Records.md) (US jet files, files with various erros, files with several jet engines, etc)
