  ...
  display() {
    ...
    e.empty(),
      ...
      new t.Setting(e)
        ...
        .addDropdown((t) => {
          t.addOption("not-change", "Do not change")
      ...
      new t.Setting(e)
        ...
        .setDesc(
          "Turn on this option if you want plugin to keep the mtime of files same during the link conversion"
        )
        .addToggle((t) =>
...
const o = (t, i) =>
  ...
  l = (i, n) =>
    e(void 0, void 0, void 0, function* () {
      ...
      "md" === e.extension
        ? yield a(e, i, n)
        : new t.Notice("Active File is not a Markdown File");
    }),
  s = (i, n, o) =>
    e(void 0, void 0, void 0, function* () {
      let e = ((e, i) => {
        ...
        l = new t.Notice("Starting link conversion", 0);
      try {
        let t = e.length,
          i = 0;
        for (let s of e)
          i++,
            l.setMessage(`Converting the links in notes ${i}/${t}.`),
  ...
  r = (i, n) =>
    e(void 0, void 0, void 0, function* () {
      ...
      if (e) {
        ...
        } else new t.Notice("You didn't select any text.");
  ...
  p = (t, e, i, n, o) => {
    ...
    if ("markdown" === t)
      return (a = "" !== i ? i : r ? r.basename : l), `[${a}](${u(l)}${C})`;
    if ("wikiTransclusion" === t) return `[[${decodeURI(l)}#${decodeURI(i)}]]`;
    if ("mdTransclusion" === t) {
      let t = i;
      return (
        i.startsWith("^") ? ((t = u(t.slice(1))), (t = `^${t}`)) : (t = u(t)),
        `[](${u(l)}${C}#${t})`
      );
    }
    return "";
...
function u(t) {
  return t.replace(/[\\\x00\x08\x0B\x0C\x0E-\x1F ]/g, (t) =>
...
class F extends t.Modal {
  ...
  onOpen() {
    ...
    const i = t.createEl("button", { text: "Cancel" });
    (i.style.cssText = "float: right;"),
      i.addEventListener("click", () => this.close());
  }
}
class T extends t.FuzzySuggestModal {
  constructor(t, e) {
  ...
  onChooseItem(t, e) {
    let i = `Are you sure you want to convert all \n            ${
      "wiki" === this.finalFormat
        ? "Markdown Links to Wikilinks"
        : "Wikilinks to Markdown Links"
    } \n            under ${t.name}?`;
    new F(this.app, i, () => s(t, this.plugin, this.finalFormat)).open();
  }
}
      ...
      (this.addFileMenuItems = (i, n) => {
        if (n instanceof t.TFile && "md" === n.extension) {
          if (
            (i.addSeparator(),
            i.addItem((t) => {
              t.setTitle("Markdown Links to Wiki")
                .setIcon("bracketIcon")
                .onClick(() => a(n, this, "wiki"));
            }),
            i.addItem((t) => {
              t.setTitle("WikiLinks to Markdown")
      ...
      console.log("Link Converter Loading..."),
        ...
        this.addCommand({
          ...
          callback: () => {
            new F(
              this.app,
              "Are you sure you want to convert all Wikilinks to Markdown Links?",
              () => C(this, "markdown")
            ).open();
          },
        }),
        this.addCommand({
          ...
          callback: () => {
            new F(
              this.app,
              "Are you sure you want to convert all Markdown Links to Wikilinks?",
              () => C(this, "wiki")
            ).open();
          },
        }),
...
module.exports = z;
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
