# Git Tutorial 
[Skip to this tutorial](tools-Eclipse) if you have enrolled in SGV in Estia 1a.
# Git - Version Control
## The problem
...
Now, we will enter the programming part of the project. See this [small tutorial](tools-Eclipse) next.
