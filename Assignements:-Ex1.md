...
Each member will need is own local repository to contribute. In a DVCS like git, every contributor as a local copy of the revision tree that they synchronize with the remote repository.  
