...
- **Patch Version (1.0.Z):** Raised for backward-compatible bug fixes. It indicates that the code remains compatible, but specific issues have been addressed. (e.g. you have discovered that you have a bug in the [Feature](../../Pandora/Features) ```avgTemp``` when the temperature are negative and you fix it.
