...
1. From your repository page, go in the "Actions" tab (in the top bar)
2. In the workflows (left navigation) Select the ```Import issues from template```
3. in the blue banner in the middle of the screen click ```run workflow```
