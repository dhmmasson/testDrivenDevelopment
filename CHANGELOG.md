...
- 2024-03-07 - [Synchronize-Update-From-The-Starterpack](Synchronize-Update-From-The-Starterpack) to help you merge the modification from the teachers
...
- 24/03/2021 - 10:16: New algorithm for **phase detection** in [instructions](Constants#algorithm).
...
- 20/03/2020 - 00:02: Added required values for the metadata section in [instructions](Constants#metadata)
- 19/03/2020 - 15:27: Added conversion values for Temperature and Pressure in [instructions](Constants#constant-values)
- 19/03/2020 - 15:27: Added conversion values for power (1 hp = `754.7` W) in [instructions](Constants#constant-values)
...
- 18/03/2020 - 23:56: We added more information in case of [special situations](Constants#special-situations)
...
- 18/03/2020 - 15:42: Flights should be around 4:00 am with your local time zone [timestamp](Constants#clues)
- 17/03/2020 - 17:25: We added some more information about [using timestamp](Constants#timestamps) in your program
- 17/03/2020 - 15:26: We added a simple heuristic to find flight phases [in the instructions](Constants#flight-phases) along with a pseudo-code in python
