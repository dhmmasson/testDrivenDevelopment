...
This Changelog tracks the change relative to the Advanced Programming Class. It does not follow the instructions from [Keep a Changelog](https://keepachangelog.com/en/1.0.0/) nor does the version follow [Semantic-Versioning](ProjectManagement/Versioning/Semantic-Versioning.md).

# 2024

- 2024-04-05 - Update the milestone-evaluation to work on tags and not on only branch
- 2024-04-05 - Update the autograder.py to use ```.``` as the decimal point to ensure that testSuite.json expected values can be wrote as ```10.23``` and not ```10,23``` which is not a valid number in json.
- 2024-03-20 - Update the documentation about test-driven-developement, add a tester for milestone 0 in the starterpack
- 2024-03-07 - [Synchronize-Update-From-The-Starterpack](ProjectManagement/Synchronize-Update-From-The-Starterpack.md) to help you merge the modification from the teachers
...
- 24/03/2021 - 10:16: New algorithm for **phase detection** in [instructions](Pandora/Constants.md#algorithm).
...
- 20/03/2020 - 00:02: Added required values for the metadata section in [instructions](Pandora/Constants.md#metadata)
- 19/03/2020 - 15:27: Added conversion values for Temperature and Pressure in [instructions](Pandora/Constants.md#constant-values) (Temperature and Pressure)
- 19/03/2020 - 15:27: Added conversion values for power (1 hp = `754.7` W) in [instructions](Pandora/Constants.md#constant-values)
...
- 18/03/2020 - 23:56: We added more information in case of [special situations](Pandora/Constants.md#special-situations)
...
- 18/03/2020 - 15:42: Flights should be around 4:00 am with your local time zone [timestamp](Pandora/Constants.md#clues)
- 17/03/2020 - 17:25: We added some more information about [using timestamp](Pandora/Constants.md#timestamps) in your program
- 17/03/2020 - 15:26: We added a simple heuristic to find flight phases [in the instructions](Pandora/Constants.md#flight-phases) along with a pseudo-code in python
...
- 13/03/2020 - 15:00: you can find more about tests files [here](Pandora/Flight-Records.md) (US jet files, files with various errors, files with several jet engines, etc)
