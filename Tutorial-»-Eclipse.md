...
* Name it, and click on the `parameter` tab (Fig. 1 -4)
...
A list of options (more than 100) to implement is [available](./Project-management»-Features.md), and this is your job to complete the program.